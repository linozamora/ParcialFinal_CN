...
echo "ACTUALIZACION DE REPOSITORIOS Y PAQUETES DEL SISTEMA"
sudo apt update
...
echo "VERSION DEL JRE"
sudo java -version

echo "INSTALANDO EL JDK"
sudo apt install default-jdk -y

echo "VERSION DEL JDK"
sudo javac -version

echo "INSTALANDO E INICIANDO EL SERVIDOR WEB"
...
echo "CREANDO ARCHIVO DE RESPUESTA .JMX"
  ...
  <hashTree>
    ...
    <hashTree>
      ...
      <hashTree>
        ...
        <hashTree/>
        <HTTPSamplerProxy guiclass="HttpTestSampleGui" testclass="HTTPSamplerProxy" testname="Petición HTTP biblioteca" enabled="true">
          <elementProp name="HTTPsampler.Arguments" elementType="Arguments" guiclass="HTTPArgumentsPanel" testclass="Arguments" testname="Variables definidas por el Usuario" enabled="true">
            <collectionProp name="Arguments.arguments"/>
          </elementProp>
        ...
        <hashTree/>
        <HTTPSamplerProxy guiclass="HttpTestSampleGui" testclass="HTTPSamplerProxy" testname="Petición HTTP noticias" enabled="true">
          <elementProp name="HTTPsampler.Arguments" elementType="Arguments" guiclass="HTTPArgumentsPanel" testclass="Arguments" testname="Variables definidas por el Usuario" enabled="true">
            <collectionProp name="Arguments.arguments"/>
          </elementProp>
